...
## Download
[Release (v1.0.2.1)](https://github.com/hudriwudi/youtube-dl-GUI/releases/tag/v1.0.2.1)

[Download .msi](https://github.com/hudriwudi/youtube-dl-GUI/releases/download/v1.0.2.1/yt-dl-GUI-setup.msi)
...
## Recommendation
The audio volume can differ from video to video. For the best listening experience, it is sound to level out the frequency of all songs.
